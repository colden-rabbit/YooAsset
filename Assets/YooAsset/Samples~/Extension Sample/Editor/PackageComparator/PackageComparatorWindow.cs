...
namespace YooAsset.Editor
{
    public class PackageComparatorWindow : EditorWindow
    {
        ...
        private void ComparePackage(List<PackageBundle> changeList, List<PackageBundle> newList)
        {
            ...
            PackageManifest manifest1  = ManifestTools.DeserializeFromBinary(bytesData1, new RestoreManifestServices()); //TODO 自行处理解密

            // 加载补丁清单1
            byte[]          bytesData2 = FileUtility.ReadAllBytes(_manifestPath2);
            PackageManifest manifest2  = ManifestTools.DeserializeFromBinary(bytesData2, new RestoreManifestServices()); //TODO 自行处理解密
